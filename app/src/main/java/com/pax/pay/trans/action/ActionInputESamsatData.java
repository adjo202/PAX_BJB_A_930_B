...
public class ActionInputESamsatData extends AAction {
    ...
    public ActionInputESamsatData(ActionStartListener listener, Context context) {
        super(listener);
        this.context = context;
    }

    public ActionInputESamsatData(Handler handler, ActionStartListener listener) {
        super(listener);
        this.handler = handler;
    }

    public ActionInputESamsatData setParam(Context context, Handler handler, String title) {
        this.context = context;
        this.handler = handler;
        this.title = title;
        return this;
    ...
    public ActionInputESamsatData setInfoTypeSale(String prompt, EInputType inputType, int maxLen, boolean isVoidLastTrans) {
        return setInfoTypeSale(prompt, inputType, maxLen, 0, isVoidLastTrans);
    }

    public ActionInputESamsatData setInfoTypeSale(String prompt, EInputType inputType, int maxLen, int minLen,
    ...
    class InputTransDataRunnable implements Runnable {
        ...
        public void run() {
                ...
                Intent intent = new Intent(context, InputESamsatDataActivity.class);
