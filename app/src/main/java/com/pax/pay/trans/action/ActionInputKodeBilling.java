...
public class ActionInputKodeBilling extends AAction {
    ...
    public ActionInputKodeBilling(ActionStartListener listener, int infoType) {
        super(listener);
        this.infoType = infoType;
    }

    public ActionInputKodeBilling(Handler handler, int infoType, ActionStartListener listener) {
        super(listener);
        this.handler = handler;
        this.infoType = infoType;
    }

    public ActionInputKodeBilling(Handler handler, int infoType, ActionStartListener listener, int trans) {
        super(listener);
        this.handler = handler;
        this.infoType = infoType;
        this.trans = trans;
    ...
    public ActionInputKodeBilling setParam(Context context, Handler handler, String title) {
    ...
    public ActionInputKodeBilling setInfoTypeSale(String prompt, EInputType inputType, int maxLen, boolean isVoidLastTrans) {
        return setInfoTypeSale(prompt, inputType, maxLen, 0, isVoidLastTrans);
    }

    public ActionInputKodeBilling setInfoTypeSale(String prompt, EInputType inputType, int maxLen, int minLen,
    ...
    public ActionInputKodeBilling setIntypeAuth(String prompt, EInputType inputType, int maxLen) {
        return setIntypeAuth(prompt, inputType, maxLen, 0);
    }

    public ActionInputKodeBilling setIntypeAuth(String prompt, EInputType inputType, int maxLen, int minLen) {
        this.prompt2 = prompt;
    ...
    class InputTransDataRunnable implements Runnable {
        ...
        public void run() {
            ...
            Intent intent = new Intent(context, InputBillingActivity.class);
