...
public class PackPembukaanRekeningReversal extends PackIso8583 {

    public PackPembukaanRekeningReversal(PackListener listener) {
        super(listener, true);
    }
    ...
    protected void setBitData90(@NonNull TransData transData) throws Iso8583Exception {
        ...
        String data = ETransType.PEMBUKAAN_REK.getMsgType();
