...
import com.pax.pay.trans.action.activity.InputDataOverbookingActivity;
import com.pax.pay.trans.action.activity.InputDataTransferctivity;

public class ActionInputDataOverBooking extends AAction {
    ...
    private static final String TAG = "ActionInputDataOverBooking";
    ...
    public ActionInputDataOverBooking(ActionStartListener listener, int infoType) {
        super(listener);
        this.infoType = infoType;
    }

    public ActionInputDataOverBooking(Handler handler, int infoType, ActionStartListener listener) {
        super(listener);
    ...
    public ActionInputDataOverBooking setParam(Context context, Handler handler, String title) {
    ...
    public ActionInputDataOverBooking setInfoTypeSale(String prompt, EInputType inputType, int maxLen, boolean isVoidLastTrans) {
        return setInfoTypeSale(prompt, inputType, maxLen, 0, isVoidLastTrans);
    }

    public ActionInputDataOverBooking setInfoTypeSale(String prompt, EInputType inputType, int maxLen, int minLen,
    ...
    public ActionInputDataOverBooking setIntypeAuth(String prompt, EInputType inputType, int maxLen) {
        return setIntypeAuth(prompt, inputType, maxLen, 0);
    }

    public ActionInputDataOverBooking setIntypeAuth(String prompt, EInputType inputType, int maxLen, int minLen) {
        this.prompt2 = prompt;
    ...
    class InputTransDataRunnable implements Runnable {
        ...
        public void run() {
                ...
                Intent intent = new Intent(context, InputDataOverbookingActivity.class);
