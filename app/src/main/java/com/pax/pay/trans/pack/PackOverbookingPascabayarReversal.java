...
public class PackOverbookingPascabayarReversal extends PackIso8583 {

    SysParam sysParam = FinancialApplication.getSysParam();

    public PackOverbookingPascabayarReversal(PackListener listener) {
        super(listener, true);
    }
    ...
    protected void setBitData11(@NonNull TransData transData) throws Iso8583Exception {
        Log.d("teg", "setBitData11 DupTransNo  : "+transData.getDupTransNo()+" - "+"TransNo : "+transData.getTransNo());
    ...
    protected void setBitData56(@NonNull TransData transData) throws Iso8583Exception {
        /*try {
            ...
            Log.d("teg", "overbooking[f56]"+f47[1] + "|" + f47[2]);
    ...
    protected void setBitData90(@NonNull TransData transData) throws Iso8583Exception {
        ...
        String data = ETransType.PASCABAYAR_OVERBOOKING.getMsgType();                                       //0200
        data += Component.getPaddedString(String.valueOf(transData.getTransNo()), 6, '0');     //000001
        data += transData.getDate() + transData.getOrigCouponDateTimeTrans(); //numpang variable            //0730103316
