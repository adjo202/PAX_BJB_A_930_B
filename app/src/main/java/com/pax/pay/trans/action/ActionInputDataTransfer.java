...
public class ActionInputDataTransfer extends AAction {
    ...
    public ActionInputDataTransfer(ActionStartListener listener, int infoType) {
        super(listener);
        this.infoType = infoType;
    }

    public ActionInputDataTransfer(Handler handler, int infoType, ActionStartListener listener) {
        super(listener);
    ...
    public ActionInputDataTransfer setParam(Context context, Handler handler, String title) {
    ...
    public ActionInputDataTransfer setInfoTypeSale(String prompt, EInputType inputType, int maxLen, boolean isVoidLastTrans) {
        return setInfoTypeSale(prompt, inputType, maxLen, 0, isVoidLastTrans);
    }

    public ActionInputDataTransfer setInfoTypeSale(String prompt, EInputType inputType, int maxLen, int minLen,
    ...
    public ActionInputDataTransfer setIntypeAuth(String prompt, EInputType inputType, int maxLen) {
        return setIntypeAuth(prompt, inputType, maxLen, 0);
    }

    public ActionInputDataTransfer setIntypeAuth(String prompt, EInputType inputType, int maxLen, int minLen) {
        this.prompt2 = prompt;
    ...
    class InputTransDataRunnable implements Runnable {
        ...
        public void run() {
                ...
                Intent intent = new Intent(context, InputDataTransferctivity.class);
