...
public class PackTarikTunaiReversal extends PackIso8583 {

    public PackTarikTunaiReversal(PackListener listener) {
        super(listener, true);
    }
    ...
    protected void setBitData90(@NonNull TransData transData) throws Iso8583Exception {
        ...
        String data = ETransType.TARIK_TUNAI.getMsgType();
