...
public class PackQRInquiry extends PackQRGenerate{

    public PackQRInquiry(PackListener listener){
        super(listener);
    }

    @Override
    protected int[] getRequiredFields() {
        return new int[]{2, 3, 4, 7, 11, 12, 13, 14, 18, 22, 23, 25, 26, 41, 42, 43, 49, 60, 62};
    }
