...
import com.pax.pay.trans.action.activity.InputPascabayarDataActivity;

public class ActionInputPascabayarData extends AAction {
    ...
    public ActionInputPascabayarData(ActionStartListener listener, Context context) {
        super(listener);
        this.context = context;
    }

    public ActionInputPascabayarData(Handler handler, ActionStartListener listener) {
        super(listener);
        this.handler = handler;
    }

    public ActionInputPascabayarData setParam(Context context, Handler handler, String title) {
        this.context = context;
        this.handler = handler;
        this.title = title;
        return this;
    ...
    public ActionInputPascabayarData setInfoTypeSale(String prompt, EInputType inputType, int maxLen, boolean isVoidLastTrans) {
        return setInfoTypeSale(prompt, inputType, maxLen, 0, isVoidLastTrans);
    }

    public ActionInputPascabayarData setInfoTypeSale(String prompt, EInputType inputType, int maxLen, int minLen,
    ...
    class InputTransDataRunnable implements Runnable {
        ...
        public void run() {
                ...
                Intent intent = new Intent(context, InputPascabayarDataActivity.class);
