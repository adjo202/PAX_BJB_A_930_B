...
import com.pax.pay.trans.action.activity.InputDataTransferActivityNew;
import com.pax.pay.trans.action.activity.InputDataTransferctivity;

public class ActionInputDataTransferNew extends AAction {
    ...
    private static final String TAG = "ActionInputDataTransfer";
    ...
    public ActionInputDataTransferNew(ActionStartListener listener, int infoType) {
        super(listener);
        this.infoType = infoType;
    }

    public ActionInputDataTransferNew(Handler handler, int infoType, ActionStartListener listener) {
        super(listener);
    ...
    public ActionInputDataTransferNew setParam(Context context, Handler handler, String title) {
    ...
    public ActionInputDataTransferNew setInfoTypeSale(String prompt, EInputType inputType, int maxLen, boolean isVoidLastTrans) {
        return setInfoTypeSale(prompt, inputType, maxLen, 0, isVoidLastTrans);
    }

    public ActionInputDataTransferNew setInfoTypeSale(String prompt, EInputType inputType, int maxLen, int minLen,
    ...
    public ActionInputDataTransferNew setIntypeAuth(String prompt, EInputType inputType, int maxLen) {
        return setIntypeAuth(prompt, inputType, maxLen, 0);
    }

    public ActionInputDataTransferNew setIntypeAuth(String prompt, EInputType inputType, int maxLen, int minLen) {
        this.prompt2 = prompt;
    ...
    class InputTransDataRunnable implements Runnable {
        ...
        public void run() {
                ...
                Intent intent = new Intent(context, InputDataTransferActivityNew.class);
