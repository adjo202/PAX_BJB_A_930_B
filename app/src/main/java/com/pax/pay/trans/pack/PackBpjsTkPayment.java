...
public class PackBpjsTkPayment extends PackIso8583 {

    public PackBpjsTkPayment(PackListener listener) {
        super(listener, true);
    }

    @Override
    protected int[] getRequiredFields() {
        return new int[]{2, 3, 4, 7, 11, 12, 13, 15, 18, 22, 28, 35, 41, 42, 43, 48, 49, 52};
    }
