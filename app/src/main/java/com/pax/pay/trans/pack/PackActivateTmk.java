...
/**
 * Created by wangyb on 2017/4/11.
 */

public class PackActivateTmk extends PackIso8583 {

    private static final String TAG = "PackActivateTmk";

    public PackActivateTmk(PackListener listener) {
        super(listener);
    }
