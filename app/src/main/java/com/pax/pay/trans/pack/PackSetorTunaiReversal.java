...
public class PackSetorTunaiReversal extends PackIso8583 {

    public PackSetorTunaiReversal(PackListener listener) {
        super(listener, true);
    }
    ...
    protected int[] getRequiredFields() {
        return new int[]{2, 3, 4, 7, 11, 12, 15, 18, 22, 28, 32, 33, 35, 37, 41, 42, 43, 48, 49, 61, 90, 103};
    }
    ...
    protected void setBitData90(@NonNull TransData transData) throws Iso8583Exception {
        ...
        String data = ETransType.SETOR_TUNAI.getMsgType();
