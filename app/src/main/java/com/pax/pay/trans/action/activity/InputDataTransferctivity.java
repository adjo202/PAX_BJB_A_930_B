...
public class InputDataTransferctivity extends BaseActivityWithTickForAction implements OnClickListener, OnItemClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_input_data_transfer_layout;
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.infos_confirm:
                try {
                    ...
                    result = new ActionResult(TransResult.SUCC, new String[]{bankName.toUpperCase(), noRekening, nominal, reffNo});
