...
public class PackOverbookingReversal extends PackIso8583 {

    SysParam sysParam = FinancialApplication.getSysParam();

    public PackOverbookingReversal(PackListener listener) {
        super(listener, true);
    }
    ...
    protected void setBitData90(@NonNull TransData transData) throws Iso8583Exception {
        ...
        String data = ETransType.OVERBOOKING_PULSA_DATA.getMsgType();
        ...
        Log.i("dia21","datetime: "+transData.getOrigCouponDateTimeTrans());
