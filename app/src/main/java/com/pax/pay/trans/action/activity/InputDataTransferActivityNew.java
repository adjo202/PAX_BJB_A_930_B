...
public class InputDataTransferActivityNew extends BaseActivityWithTickForAction implements OnClickListener, OnItemClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_input_data_transfer_new_layout;
    }
    ...
    protected void initViews() {
        ...
        ArrayList<String> listBank = getBankList();
        Collections.sort(listBank);

        spinnerDialog = new SpinnerDialog(InputDataTransferActivityNew.this, listBank,
                "Daftar Bank");
...
//                Toast.makeText(InputDataPBBActivity.this, item + "  " + position + "", Toast.LENGTH_SHORT).show();
    ...
    private ArrayList<String> getBankList(){
    ...
    private Currency getDefaultCurrency(){
        Currency currency = Currency.CUSTOM;
        currency.setCode("360");
        currency.setName("RP");
...
//        }
        ...
        if (TextUtils.isEmpty(nominal) || nominal.equals("0")) {
