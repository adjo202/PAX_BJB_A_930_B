...
public class InputBillingActivity extends BaseActivityWithTickForAction implements OnClickListener {
    public static final String TAG = "InputBillingActivity";
    ...
    private ActionInputKodeBilling.EInputType inputType;
    ...
    protected void loadParam() {
        ...
        inputType = (ActionInputKodeBilling.EInputType) getIntent().getSerializableExtra("tipe");
    ...
    protected void setListeners() {
        ...
        btnScanner.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScanCodeUtils.getInstance().start(InputBillingActivity.this, handler);
            }
        });
    ...
    private String proses() {
        String result = "";
        billing = mEditText.getText().toString();
        ...
        if (billing.length()!=15){
            result = "Format Kode Billing Salah";
            mEditText.setText("");
            return result;
        }

        pref = billing.substring(0, 1);

        switch (trans){
            case 1:
                if (!(pref.equals("0") || pref.equals("1") || pref.equals("2") || pref.equals("3"))){
                    result = "Format Kode Billing DJP Salah";
                    mEditText.setText("");
                    return result;
                }
                break;
            case 2:
                if (!(pref.equals("4") || pref.equals("5") || pref.equals("6"))){
                    result = "Format Kode Billing DJBC Salah";
                    mEditText.setText("");
                    return result;
                }
                break;
            case 3:
                if (!(pref.equals("7") || pref.equals("8") || pref.equals("9"))){
                    result = "Format Kode Billing DJA Salah";
                    mEditText.setText("");
                    return result;
                }
                break;
    ...
    private void infoConfirm() {
        ...
        if (!TextUtils.isEmpty(promptStr)) {
            ToastUtils.showMessage(InputBillingActivity.this, promptStr);
            return;
        }
        ...
        switch (inputType) {
            ...
            case ALPHNUM:
                ...
                if (TextUtils.isEmpty(content)) {
                    ToastUtils.showMessage(InputBillingActivity.this, getString(R.string.please_input_again));
                    mEditText.requestFocusAndTouch(keyboardUtil);
                }
                break;
            case AMOUNT:
        ...
        Log.d(TAG,"billing : " + billing);
        ActionResult result = new ActionResult(TransResult.SUCC, billing);
        finish(result);
    ...
    private void showSysKeyboard() {
        if (inputType == ActionInputKodeBilling.EInputType.TEXT || inputType == ActionInputKodeBilling.EInputType.ALPHNUM) {
