...
import com.pax.pay.trans.action.activity.SearchCardCustomActivity;
import com.pax.pay.trans.model.TransData;

public class ActionSearchCardCustom extends AAction {
    ...
    public ActionSearchCardCustom(ActionStartListener listener) {
        super(listener);
    }

    public ActionSearchCardCustom(TransData data, ActionStartListener listener) {
        super(listener);
        mTransData = data;
    }
     ...
     * 
     */
    public static class SearchCustomMode {
        /**
         * 刷卡
         */
    ...
    protected void process() {
        ...
        Intent intent = new Intent(context, SearchCardCustomActivity.class);
