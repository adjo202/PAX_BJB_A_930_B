...
public class PackOverbookingInquiry1 extends PackIso8583 {

    public PackOverbookingInquiry1(PackListener listener) {
        super(listener, true);
    }
    ...
    protected void setBitData103(@NonNull TransData transData) throws Iso8583Exception {
        setBitData("103",transData.getField103()); // 0056763406101
    }
