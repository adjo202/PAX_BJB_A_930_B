...
public enum CountryCode {
    ...
    static {
        for (com.pax.pay.utils.CountryCode cc : values()) {
     ...
     */
    public static com.pax.pay.utils.CountryCode getByCode(String code) {
        if (code == null) {
            return null;
        }
    ...
    private static com.pax.pay.utils.CountryCode getByAlpha2Code(String code) {
        try {
            return Enum.valueOf( com.pax.pay.utils.CountryCode.class, code);
    ...
    private static com.pax.pay.utils.CountryCode getByAlpha3Code(String code) {
     ...
     * @return A CountryCode instance, or null if not found.
     */
    public static com.pax.pay.utils.CountryCode getByCode(int code) {
