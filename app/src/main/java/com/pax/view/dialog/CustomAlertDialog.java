...
public class CustomAlertDialog extends Dialog implements TickTimerListener, android.view.View.OnClickListener {
    ...
    public static final int NORMAL_TYPE_TIMEOUT = 7;
    ...
    public void onFinish() {
        ...
        if (mAlertType == ERROR_TYPE || mAlertType == SUCCESS_TYPE || mAlertType == NORMAL_TYPE_TIMEOUT) {
            if (getContext() != null) {
                try {
