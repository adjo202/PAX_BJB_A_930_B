...
public class MenuPopupWindow extends PopupWindow {
    ...
    // 列表弹窗的间隔
    protected static final int LIST_PADDING = 20;
    ...
    public void show(View view) {
        ...
        showAtLocation(view, popupGravity,
                mScreenWidth - mContext.getResources().getDimensionPixelOffset(R.dimen.menu_pop_location),
                mRect.bottom + 5);
    }
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                            mContext.getResources().getDimensionPixelOffset(R.dimen.menu_pop_text_size));
                    // 设置文本居中
