...
public class QRView extends View {
    ...
    public static final String TAG = "QRView";
    /**
     * 笔画X坐标起点
     */
    private float mX;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        cachebBitmap = FinancialApplication.getGl().getImgProcessing().generateBarCode(text, 500, 500, BarcodeFormat.QR_CODE);
        canvas.drawBitmap(cachebBitmap, 100, 150, mGesturePaint);
